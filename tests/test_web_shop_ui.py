...
def test_registration_user(web_browser, gender, first_name, last_name, email, password):
...
def test_auth_user(web_browser):
...
def test_search_product(open_browser_through_api, product):
...
def test_add_product_to_cart(open_browser_through_api, category):
...
def test_delete_product_from_cart(open_browser_through_api, category):
